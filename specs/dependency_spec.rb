...
describe Jars::Installer::Dependency do
  it "should parse dependency line only if it is jar or pom" do
    Jars::Installer::Dependency.new(+"something").must_be_nil
    Jars::Installer::Dependency.new(+"   org.apache.maven:maven-repository-metadata:jar:3.1.0:compile:/usr/local/repository/org/apache/maven/maven-repository-metadata/3.1.0/maven-repository-metadata-3.1.0.jar").wont_be_nil
    Jars::Installer::Dependency.new(+"   org.apache.maven:maven-repository-metadata:pom:3.1.0:compile:/usr/local/repository/org/apache/maven/maven-repository-metadata/3.1.0/maven-repository-metadata-3.1.0.jar").wont_be_nil
  end
